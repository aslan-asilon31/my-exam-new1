    ...
    <x-card  :title="$title"  :url="$url" >
        ...
        <div class="flex items-center space-x-4 pb-2">
            <x-stat
                ...
                icon="o-envelope"
                tooltip="Hello"
                color="text-[#954832]" class="text-md md:text-xl"/>
        ...
        <div class="mt-6">
            ...
            <div class="flex items-center mt-6">
                <button class="p-2 bg-[#954832] text-white rounded-md" wire:click="openModal" label="Tambah Peserta">
                    <p class="text-sm ">  <x-icon name="o-plus" /> Tambah Peserta </p>
                 </button>
            </div>
